    ...
    <main className="relative min-h-screen text-foreground">
      <section className="max-w-2xl mx-auto min-h-screen px-6 pt-28 pb-24 md:px-12 flex flex-col gap-14 justify-center">
        ...
        <motion.div {...fadeUp(0)} className="flex flex-col gap-3 text-center">
          <p className="text-xs font-mono tracking-[4px] text-primary/50 uppercase">Get In Touch</p>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-foreground">Contact Me</h1>
        ...
        <motion.div {...fadeUp(0.15)} className="flex flex-col gap-3">
          <p className="text-xs font-mono tracking-[4px] text-primary/50 uppercase mb-1">Direct</p>
          {contactItems.map((item, i) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs font-mono text-muted-foreground/50 tracking-widest uppercase">{item.label}</span>
                {item.href ? (
        ...
        {socials.length > 0 && (
          <motion.div {...fadeUp(0.25)} className="flex flex-col gap-3">
            <p className="text-xs font-mono tracking-[4px] text-primary/50 uppercase mb-1">Socials</p>
